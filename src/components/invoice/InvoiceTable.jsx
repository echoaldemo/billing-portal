...
import ManualInvoice from "../new-invoice/manual/ManualInvoice";
import AutomaticInvoice from "../new-invoice/automatic/AutomaticInvoice";
        ...
        {numSelected > 0 ? (
          ...
          <>
            ...
            <Tooltip title="Add new automatic invoice">
              <Button className="add-btn" onClick={handleOpenAuto}>
